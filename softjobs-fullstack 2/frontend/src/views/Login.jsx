...
const Login = () => {
  ...
  const handleForm = (event) => {
    ...
    axios.post(ENDPOINT.login, user)
      ...
      .catch((err) => {
        // Axios puede venir sin "response" (backend caído / CORS / red)
        const message = err?.response?.data?.message || 'No se pudo iniciar sesión. Revisa que el backend esté corriendo y tus credenciales.'
        console.error(err)
